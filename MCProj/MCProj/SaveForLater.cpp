...
//        }
//
//        QString username = m_usernameField->selectedText();
...
//        std::string confirmPasswordStd = confirmPassword.toUtf8().constData();
//
//        qDebug() << "Username as std::string:" << QString::fromStdString(usernameStd);
//        qDebug() << "Password as std::string:" << QString::fromStdString(passwordStd);
//        qDebug() << "Confirm Password as std::string:" << QString::fromStdString(confirmPasswordStd);
//
